...
<pre>The average of the ratio between query rating and its position.</pre>

<p>We also define <code>poor query percentage</code> as:<p>

<pre>The percentage of all queries with rating less than 3.</pre>

<p>Write a solution to find each <code>query_name</code>, the <code>quality</code> and <code>poor_query_percentage</code>.</p>

<p>Both <code>quality</code> and <code>poor_query_percentage</code> should be rounded to 2 decimal places.</p>
