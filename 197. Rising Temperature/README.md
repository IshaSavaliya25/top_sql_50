...
<p>The resulting table should have the <code>machine_id</code> along with the average time as <code>processing_time</code>, which should be <strong>rounded to 3 decimal places</strong>.</p>
